...
function mockResponse(req: AiRequest): string {
  ...
  switch (req.task) {
    ...
    case "recommendation":
      return `Жеке ұсыныс: соңғы нәтижелеріңе қарағанда, "Динамика" және "Импульс" тақырыптарын қайталап шыққан жөн. Сосын тиісті модульдің ойынын қайта ойнап, білімді бекіт.`;
    default:
